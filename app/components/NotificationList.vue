    ...
    <div class="space-y-4">
        ...
        <div v-else class="space-y-2">
            <div v-for="notification in notifications" :key="notification.id"
                class="group relative p-4 rounded-xl border transition-all duration-200 cursor-pointer hover:shadow-sm"
                :class="[
                ...
                <div class="flex gap-4">
                    ...
                    <div class="flex-shrink-0 relative">
                        ...
                        <div v-if="!notification.is_read"
                            class="absolute -top-1 -right-1 w-3 h-3 bg-red-500 dark:bg-red-400 rounded-full animate-pulse" />
                    </div>
                    ...
                    <div class="flex-1 min-w-0 space-y-2">
                        ...
                        <div class="flex items-start justify-between gap-3">
                            <h4 class="font-semibold text-sm text-neutral-900 dark:text-gray-100 leading-tight">
                                {{ notification.title }}
                            </h4>
                        ...
                        <p class="text-sm text-neutral-600 dark:text-gray-300 leading-relaxed">
                ...
                <div
                    class="absolute inset-0 rounded-xl bg-gradient-to-r from-transparent via-white/10 dark:via-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none" />
            </div>
        </div>
    </div>
</template>
